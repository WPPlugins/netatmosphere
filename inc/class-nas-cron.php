...
if ( !function_exists( 'nas_cron_execute_data_merge' ) ) {
    ...
    function nas_cron_execute_data_merge() {
        NAS_Plugin::debugFile('nas_cron_execute_data_merge', __FILE__, __LINE__);
        //return;
...
if ( !function_exists( 'nas_cron_execute_device_refresh' ) ) {
    ...
    function nas_cron_execute_device_refresh() {
        NAS_Plugin::debugFile('nas_cron_execute_device_refresh', __FILE__, __LINE__);
        //return;
...
class NAS_Cron {
    ...
    public static function scheduleDeviceRefresh() {
        wp_schedule_event(time() + 20, 'daily', NAS_CRON_DEVICES_EVENT );
    }
    ...
    public static function scheduleDataMerge() {
        wp_schedule_event(time() + 30, 'hourly', NAS_CRON_DATA_EVENT );
    }
